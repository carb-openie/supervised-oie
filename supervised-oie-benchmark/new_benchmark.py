'''
Usage:
   benchmark --gold=GOLD_OIE --out=OUTPUT_FILE (--openiefive=OPENIE5 | --stanford=STANFORD_OIE | --ollie=OLLIE_OIE |--reverb=REVERB_OIE | --clausie=CLAUSIE_OIE | --openiefour=OPENIEFOUR_OIE | --props=PROPS_OIE | --tabbed=TABBED_OIE | --msr=MSR | --benchmarkGold=BENCHMARK_GOLD) [--exactMatch | --predMatch | --argMatch | --binaryMatch | --simpleMatch] [--error-file=ERROR_FILE] [--binary]
...
from oie_readers.msrReader import MsrReader
